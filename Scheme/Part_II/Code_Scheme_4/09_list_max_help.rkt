...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname list_max_help) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))

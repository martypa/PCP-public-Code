...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname 15_list_definitions_functions) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))

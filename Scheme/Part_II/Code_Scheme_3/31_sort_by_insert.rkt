...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname sort_by_insert) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
